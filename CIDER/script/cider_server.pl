...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{CIDER_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{CIDER_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
cider_server.pl - Catalyst Testserver

=head1 SYNOPSIS

cider_server.pl [options]
